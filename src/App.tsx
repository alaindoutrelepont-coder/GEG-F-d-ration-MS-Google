...
import { PHASES, Phase, Step } from './constants';
...
const IconMap: Record<string, React.ReactNode> = {
  ...
  ShieldCheck: <ShieldCheck className="w-6 h-6 text-google-blue" />,
  Zap: <Zap className="w-6 h-6 text-google-yellow" />,
  Lock: <Lock className="w-6 h-6 text-google-red" />,
};
                  ...
                  >
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <p className="text-secondary" dangerouslySetInnerHTML={{ __html: step.description }} />
                      </div>
                    </div>
                      ...
                      {step.details.map((detail, dIdx) => (
                        <React.Fragment key={dIdx}>
                          <li className="flex items-start gap-3 text-secondary">
                            ...
                            <span className="leading-relaxed" dangerouslySetInnerHTML={{ __html: detail }} />
                          </li>
